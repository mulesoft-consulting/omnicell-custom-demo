...
//	HealthCloudGA__TypeLabel__c: (payload.Data.ADT_A04.PV1."PV1-07"."CN_PHYSICIAN-03")[0] ++ " " ++ (payload.Data.ADT_A04.PV1."PV1-07"."CN_PHYSICIAN-02")[0] default "",
	(HealthCloudGA__Practitioner__c: (PV."PV1-07"."CN_PHYSICIAN-01")[0]) if ((PV."PV1-07"."CN_PHYSICIAN-01")[0] != null),
	(HealthCloudGA__TypeCode__c: (PV."PV1-07"."CN_PHYSICIAN-06")[0]) if ((PV."PV1-07"."CN_PHYSICIAN-06")[0] != null)
