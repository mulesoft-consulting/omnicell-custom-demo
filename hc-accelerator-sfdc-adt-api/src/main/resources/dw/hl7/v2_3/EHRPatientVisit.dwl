...
//	(HealthCloudGA__HospitalizePreAdmissionId__c: PV."PV1-05"."CX-01") if (PV."PV1-05"."CX-01" != null),
	(HealthCloudGA__HospitalizationOrigin__c: PV."PV1-06"."PL-01") if (PV."PV1-06"."PL-01" != null),
//	(HealthCloudGA__HospitalizeOrigin__c: PV."PV1-06"."PL-01") if (PV."PV1-06"."PL-01" != null),
	(HealthCloudGA__HospitalizeAdmitSourceCode__c: (PV."PV1-08"."XCN-01")[0]) if ((PV."PV1-08"."XCN-01")[0] != null),
//	HealthCloudGA__HospitalAdmitSourceLabel__c: ((payload.Data.ADT_A04.PV1."PV1-08"."XCN-03")[0] ++ " " ++ (payload.Data.ADT_A04.PV1."PV1-08"."XCN-02")[0]) default "",
...
//	(HealthCloudGA__Location1Name__c: PV."PV1-42"."PL-01") if (PV."PV1-42"."PL-01" != null),
//	(HealthCloudGA__Location1Type__c : PV."PV1-42"."PL-06") if (PV."PV1-42"."PL-06" != null),
//	(HealthCloudGA__Location1Description__c : PV."PV1-42"."PL-05") if (PV."PV1-42"."PL-05" != null),
